...
class IngresosViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun agregarIngreso(concepto: String, monto: Double, fecha: Long, categoria: String) {
        viewModelScope.launch {
            repository.insertarIngreso(Ingreso(concepto = concepto, monto = monto, fecha = fecha, categoria = categoria))
        }
    }
